...
const CLUB_BADGES = {
    ...
    "Cesena FC": "https://upload.wikimedia.org/wikipedia/en/thumb/6/62/Cesena_FC.png/50px-Cesena_FC.png",
    ...
    "Casa Pia AC": "https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Casa_Pia_A.C.png/50px-Casa_Pia_A.C.png",
    "Gil Vicente FC": "https://upload.wikimedia.org/wikipedia/en/thumb/4/47/Gil_Vicente_F.C._logo.svg/50px-Gil_Vicente_F.C._logo.svg.png",
    "CS Marítimo": "https://upload.wikimedia.org/wikipedia/en/thumb/7/7f/C.S._Mar%C3%ADtimo_logo.svg/50px-C.S._Mar%C3%ADtimo_logo.svg.png",
    ...
    "Orlando City SC": "https://upload.wikimedia.org/wikipedia/en/thumb/4/4c/Orlando_City_2014.svg/50px-Orlando_City_2014.svg.png",
    "Atlanta United FC": "https://upload.wikimedia.org/wikipedia/en/thumb/6/6a/Atlanta_United_FC_logo_2024.svg/50px-Atlanta_United_FC_logo_2024.svg.png"
};

// Función para obtener el escudo de un club (con fallback)
...
function renderClubBadge(clubName) {
    ...
    if (badge) {
        return `<img src="${badge}" alt="${clubName}" class="club-badge" onerror="this.style.display='none';this.nextElementSibling.style.display='inline'"><span class="badge-fallback" style="display:none">⚽</span>`;
    }
